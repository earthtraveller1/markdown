...
Regular Paragraph
    ...
    assert_eq!(paragraphs[0].render_html(), "<p><h1>Title</h1></p>");
    assert_eq!(paragraphs[1].render_html(), "<p><h2>Second Title</h2></p>");
    assert_eq!(paragraphs[2].render_html(), "<p><h3>Third Title</h3></p>");
